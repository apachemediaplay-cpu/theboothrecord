# iletthephoneri · subject #1373

**Confession** — i let the phone ring out then text back
**Verdict** — You let it ring so you could put a backspace key on your own mouth.
...
1. i let the phone ring out then text back
2. i let the phone ring
3. i let the phone ring out
4. i let the phone ring out then
