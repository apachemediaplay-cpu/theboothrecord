...
import colaVice from "@/assets/cola-vice.png";
import citrusConfessional from "@/assets/citrus-confessional.png";
import bitterJustice from "@/assets/bitter-justice.png";
                  ...
                  {isMain ? (
                    <>
                      ...
                      <div className="px-6 md:px-8 pt-6 md:pt-8 pb-6 md:pb-8">
                         <h3 className="font-control text-2xl md:text-3xl text-black tracking-tight uppercase mb-2 font-bold">
                           DROP 002
                         </h3>
