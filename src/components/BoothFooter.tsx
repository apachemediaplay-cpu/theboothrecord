...
interface BoothFooterProps {
  showConsent?: boolean;
}

const BoothFooter = ({ showConsent = false }: BoothFooterProps) => {
  return (
    <div className="fixed bottom-0 left-0 right-0 pb-6 pt-4 flex flex-col items-center gap-4 bg-gradient-to-t from-background via-background to-transparent">
      <GuiltyLogo />
      {showConsent && (
        <p className="text-whisper text-[8px] md:text-[10px] font-mono-light flex items-center gap-2 whitespace-nowrap">
